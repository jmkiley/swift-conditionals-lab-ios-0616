...
func isGreater(first first : Int, second : Int) -> Bool {
    return (first > second)
}

isGreater(first: 6, second: 3)
...
func compareBankAccounts(myAccount myAccount : Int, theirAccount : Int) {
    var theirAccount = theirAccount
